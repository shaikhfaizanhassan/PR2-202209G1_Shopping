                ...
                <ul class="nav navbar-nav center_nav pull-right">
                  ...
                  <li class="nav-item submenu dropdown">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      while ($r1 = mysqli_fetch_array($getcat)) {
                  ...
                  <li class="nav-item submenu dropdown">
                    ...
                    <ul class="dropdown-menu">
                      <?php
                      $getcat = mysqli_query($con, "select * from brand");
                      while ($r1 = mysqli_fetch_array($getcat)) {
  ...
  <section class="inspired_product_area section_gap_bottom_custom">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-12">
          <div class="main_title">
            <h2><span>Brand Wise Product</span></h2>
      ...
      <div class="row">
        ...
        {
            $bid = $_GET["BrandDetail"];
            $showcat = mysqli_query($con,"SELECT * FROM product WHERE brand_id ='$bid'");
            while($pp = mysqli_fetch_array($showcat))
            {
          ...
          <div class="col-lg-3 col-md-6">
            <div class="single-product">
              <div class="product-img">
                <img class="img-fluid w-100" src="Admin/proimage/<?php echo $pp[6] ?>" alt="" />
                <div class="p_icon">
                  <a href="#">
                    <i class="ti-eye"></i>
                  </a>
