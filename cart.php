    ...
    <div class="container">
      <div class="cart_inner">
        ...
        <?php }} ?>
            ...
            <td style="font-weight:bolder"><?php echo $netamount ?></td>
            
        </tr>
             
        <tr>
          <td> <input type="submit" class="btn btn-primary" value="Process To Check Out" name="check"></td>
        </tr>
